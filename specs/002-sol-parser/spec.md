...
reference and IR schema (`scaffold/advanced/sol-reference.md`; full grammar in the swarm repo); this spec contracts the parser that realizes them, it does not
